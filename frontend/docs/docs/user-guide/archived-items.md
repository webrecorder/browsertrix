...
An archived item status represents how the item came to exist in Browsertrix.

| Status | Description |
| ---- | ---- |
| <span class="status-green-600">:bootstrap-upload: Uploaded</span> | The item was created by importing a WACZ file. |
| <span class="status-green-600">:bootstrap-check-circle-fill: Complete</span> | The item was created by a crawl run that successfully finished. All pages within the crawl workflow's scope and limits have been crawled and are included in the archived item. |
