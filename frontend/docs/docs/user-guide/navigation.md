...
![Browsertrix dashboard with org navigation highlighted](../assets/screenshots/browsertrix-app-1.png){ .wr-image }
...
![Browsertrix org with one active crawl, which appears at the top of the collections page](../assets/screenshots/active-crawl-status-feature-1.png){ .wr-image }

Hover over or focus on the total number of crawls to view a breakdown of running, waiting, or paused crawl runs.

![Hovering or focusing on the the active crawls indicator will open a dropdown menu of active crawl statuses](../assets/screenshots/active-crawl-status-feature-2-cropped.png){ .wr-image }
...
![Browsertrix “Crawl Runs” page with one running crawl](../assets/screenshots/active-crawl-status-feature-3.png){ .wr-image }
...
![Browsertrix dashboard with org selector highlighted](../assets/screenshots/browsertrix-app-2.png){ .wr-image }

You can view all the orgs you belong to by tapping the current org’s name.

![Browsertrix dashboard with open org selector highlighted](../assets/screenshots/browsertrix-app-3.png){ .wr-image }
