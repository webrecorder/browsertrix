...
![Image title](../assets/screenshots/browsertrix-app-1.png){ .wr-image alt="Browsertrix dashboard with org navigation highlighted" }
...
![Image title](../assets/screenshots/active-crawl-status-feature-2-cropped.png){ .wr-image alt="Hovering or focusing on the the active crawls indicator will open a dropdown menu of active crawl statuses"  }
...
![Image title](../assets/screenshots/active-crawl-status-feature-3.png){ .wr-image alt="Browsertrix “Crawl Runs” page with one running crawl" }
...
![Image title](../assets/screenshots/browsertrix-app-2.png){ .wr-image alt="Browsertrix dashboard with org selector highlighted" }

You can view all the orgs you belong to by tapping the current org’s name.

![Image title](../assets/screenshots/browsertrix-app-3.png){ .wr-image alt="Browsertrix dashboard with open org selector highlighted" }
