...
The WACZ format was developed by Webrecorder to establish a file packaging convention for all the data needed by a browser for the efficient rendering and user-friendly contextualization of a web archive. [View full WACZ specification :octicons-link-external-16:](https://specs.webrecorder.net/wacz/latest/){ target="_blank" }
