  ...
  (severity: Severity | ReviewStatus, classList?: string) => {
    ...
    switch (severity) {
      ...
      case "severe":
        return html`<sl-icon
          name="x-octagon-fill"
          class=${clsx("text-danger", baseClasses, classList)}
        ></sl-icon>`;
      case "moderate":
        return html`<sl-icon
          name="dash-square-fill"
          class=${clsx("text-amber-600", baseClasses, classList)}
        ></sl-icon>`;
      case "good":
        return html`<sl-icon
      ...
      case "rejected":
        return html`<sl-icon
          ...
          class=${clsx("text-warning", baseClasses, classList)}
        ></sl-icon>`;
      case "commentOnly":
      ...
      default:
        return html`<sl-icon
          name="slash-circle"
          class=${clsx("text-gray-400", baseClasses, classList)}
        ></sl-icon>`;
    }
  },
);
