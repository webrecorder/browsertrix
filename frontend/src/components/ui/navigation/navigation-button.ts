...
export class Button extends TailwindElement {
  ...
  render() {
    ...
    return html`<${tag}
      ...
      class=${[
        tw`focus-visible:outline-3 flex w-full cursor-pointer items-center gap-2 rounded font-medium leading-[16px] outline-primary-600 transition hover:transition-none focus-visible:outline focus-visible:outline-offset-1 disabled:cursor-not-allowed disabled:bg-transparent disabled:opacity-50`,
