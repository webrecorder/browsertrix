...
/**
 * A dropdown menu of options that are filtered by text typed in by the user.
 * Unlike `<btrix-combobox>`, `<btrix-autocomplete>` is not a form control.
 *
 * @event request-close
 */
@customElement("btrix-autocomplete")
