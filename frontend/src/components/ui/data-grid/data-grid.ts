...
export const dataGrid = <const T extends GridItem = GridItem>(
  props: Pick<
    DataGrid<T>,
    | "columns"
    | "items"
  ...
  const { columns, items, stickyHeader, rowKey, rowsSelectable, selectMode } =
    props;
  ...
  return html`
    <btrix-data-grid
      ...
      .rowsExpandable=${props.rowsExpandable}
      .rowsRemovable=${props.rowsRemovable}
      .rowsAddible=${props.rowsAddible}
      .alignRows=${props.alignRows}
      .addRowsInputValue=${props.addRowsInputValue}
      .editCells=${props.editCells}
      .disabled=${props.disabled}
      .defaultItem=${props.defaultItem}
      .formControlLabel=${props.formControlLabel}
      .formControlLabelId=${props.formControlLabelId}
      .rowsController=${props.rowsController}
    >
    </btrix-data-grid>
  `;
};
